...
require_once __DIR__ . '/git_helper.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'add') {
    ...
    if (empty($errors)) {
        ...
        $repoDir = __DIR__;
        $commitMessage = "Updated client JSON for client {$clientId} at " . date('Y-m-d H:i:s');

        // Push only the updated client JSON file
        gitCommitAndPushJsonFile($repoDir, $clientFile, $commitMessage);
